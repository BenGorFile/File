...
/**
 * Spec file of SuffixNumberUploadFileCommand class.
 *
 * @author Beñat Espiña <benatespina@gmail.com>
 * @author Gorka Laucirica <gorka.lauzirika@gmail.com>
 */
class SuffixNumberUploadFileCommandSpec extends ObjectBehavior
{
    function it_creates_command()
    {
        $this->beConstructedWith('dummy-file-name.pdf', 'pdf-content', 'application/pdf');
        $this->shouldHaveType(SuffixNumberUploadFileCommand::class);
